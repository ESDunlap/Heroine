...
public class HeroineFallingState : MonoBehaviour, IHeroineState
{
    ...
    void Update()
    {
        if (_heroineController)
        {
            _heroineController.rb.AddForce(Vector3.down * _heroineController.fallingSpeed * Time.deltaTime, ForceMode.Impulse);
